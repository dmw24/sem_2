...
async function initializeApp() {
    ...
    try {
        ...
        if (typeof populateScenarioDropdown === 'function') {
            console.log('Scenarios before populating:', appState.structuredData.scenarios);
            populateScenarioDropdown(appState.structuredData);
        }
